    ...
    <Layout>
        <section className='h-80 bg-header pt-40'>
            <div className='container mx-10 lg:mx-40'>
                <h1 className='text-5xl md:text-6xl lg:text-7xl font-extrabold text-white' data-aos="fade-right">About us<span className='accent-text'>.</span></h1>
            </div>
        </section>
            ...
            <div className='containerz'>
              <div className='grid-rows-1 mt-36'>
                <div className='columns-lg pl-0 offset-left mr-10 lg:mr-60 bg-dk'>
                  <h2 className='text-3xl md:text-4xl lg:text-5xl font-extrabold leading-tight text-white mt-28' data-aos="fade-left">Client Feedback</h2><br></br>
                  <p className='leading-loose text-white' data-aos="fade-left">It is an honor to receive a visit from the Governor of West Java. This visit serves as recognition for our efforts and contributions in supporting the development and progress of this region. We view this visit as an opportunity to share our work outcomes, innovative ideas, and the challenges we face as we collectively strive to advance West Java.</p>
                  <br></br>
                  <p className='leading-loose text-white mb-28' data-aos="fade-left">Alongside us during this visit were senior executives from PT Masdar. This collaboration signifies the strong partnership between our organization and PT Masdar, reflecting our joint commitment to advancing renewable energy and sustainable initiatives in this region.</p>
                </div>
              </div>
            </div>
          </div>
